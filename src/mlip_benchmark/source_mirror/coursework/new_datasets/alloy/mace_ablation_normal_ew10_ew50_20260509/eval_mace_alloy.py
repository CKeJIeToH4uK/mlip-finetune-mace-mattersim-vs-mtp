...
def eval_one(model_path, test_path, output_json, dataset_name, split, run_type):
...
if __name__ == "__main__":
    ...
    valid = eval_one(
        ...
        dataset_name=f"alloy_valid_{args.run_type}",
        split="valid",
    ...
    train = eval_one(
        ...
        dataset_name=f"alloy_train_{args.run_type}",
        split="train",
        run_type=args.run_type,
    )

    write_summary_csv(
        os.path.join(args.out_dir, "eval_metrics.csv"),
        [train, valid],
    )
