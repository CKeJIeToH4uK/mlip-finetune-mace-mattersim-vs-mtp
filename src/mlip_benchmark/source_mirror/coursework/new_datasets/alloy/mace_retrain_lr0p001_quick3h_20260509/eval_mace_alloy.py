...
if __name__ == "__main__":
    ...
    valid = eval_mace(
        ...
        dataset_name="alloy_valid_lr0p001_quick3h",
        split="valid",
    )
    ...
    train = eval_mace(
        ...
        dataset_name="alloy_train_lr0p001_quick3h",
        split="train",
    )

    write_summary_csv(
        os.path.join(args.out_dir, "eval_metrics_quick3h.csv"),
        [train, valid],
    )
