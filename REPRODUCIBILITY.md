...
Ожидаемый уровень воспроизводимости — проверка согласованности включенных таблиц, скриптов и материалов происхождения результатов. Полная процедура обучения требует внешних тяжелых данных и артефактов, которые намеренно не входят в clean repo.
