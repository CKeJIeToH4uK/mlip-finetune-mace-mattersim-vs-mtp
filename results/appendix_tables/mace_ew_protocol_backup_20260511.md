...
- `MACE default` locally refers to the MoNbTaVW fair comparison baseline with `lr=0.001`, `fair200`, and default loss, as listed in `results/verified_metrics/monbtavw_metrics_verified_20260511.csv` and the archived handoff table `archive/old_contexts/new_chat_presentation_context_20260511/PRESENTATION/03_content/results_handoff/alloy_mace_ablation_table.md`.
