...
`coursework_clean/` — это полная, но отфильтрованная версия исследовательского репозитория. Она предназначена для просмотра результатов, проверки происхождения численных данных, анализа кода, протоколов экспериментов, графиков и архивного контекста.
